...
class TimeTrackingAPI {
    ...
    public function __construct() {
        try {
            ...
            // Pour les actions de pointage normal, on vérifie juste que l'utilisateur est connecté
            // Pour les actions admin, on vérifie les droits admin
    ...
    public function handleRequest() {
        ...
        try {
            switch ($action) {
                // Actions utilisateur normales - nécessitent juste d'être connecté
                case 'clock_in':
                case 'clock_out':
                case 'start_break':
                case 'end_break':
