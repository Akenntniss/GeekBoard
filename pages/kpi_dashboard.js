                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="ai-profile-card" data-profile-id="${profile.id}">
                        ...
                        <div class="ai-profile-footer">
                            <button class="btn-ai-action" onclick="openAIAnalysisModal(${profile.id}, '${this.escapeHtml(profile.name)}', '${this.escapeHtml(profile.description || '')}')">
...
async function launchAIAnalysis() {
    ...
    // Masquer le bouton, afficher l'animation
