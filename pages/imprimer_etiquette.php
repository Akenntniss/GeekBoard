...
// Récupérer le layout sélectionné (ou celui par défaut si aucun n'est défini)
$selectedLayout = isset($_GET['layout']) ? cleanInput($_GET['layout']) : LabelManager::getSelectedLayout($shop_pdo);

// Charger et afficher le layout
try {
...
// Fin du script - ne pas afficher le reste de l'ancien code
exit;
?>
