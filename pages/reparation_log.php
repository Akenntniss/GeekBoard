...
$query_users = "SELECT id, full_name FROM users ORDER BY full_name";
...
$sql = "SELECT l.*, r.num_reparation, r.appareil, r.modele, c.nom as client_nom, c.prenom as client_prenom, u.full_name as user_nom 
