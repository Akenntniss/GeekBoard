...
@media (max-width: 767px) {
    #desktop-navbar, nav#desktop-navbar {
        ...
        /* ========================================
   NAVBAR MODE NUIT - CORRECTIONS OBLIGATOIRES
        ======================================== */
/* Navbar en mode nuit - Forcer la visibilité */
body.night-mode #desktop-navbar,
body.night-mode nav#desktop-navbar,
.night-mode #desktop-navbar,
.night-mode nav#desktop-navbar {
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
    position: fixed !important;
...
/* Éléments navbar visibles en mode nuit */
body.night-mode #desktop-navbar *,
.night-mode #desktop-navbar * {
    visibility: visible !important;
    opacity: 1 !important;
...
/* Container navbar mode nuit */
body.night-mode #desktop-navbar .container-fluid,
.night-mode #desktop-navbar .container-fluid {
    display: flex !important;
    align-items: center !important;
    justify-content: space-between !important;
    height: 100% !important;
...
.night-mode .servo-logo-container {
    position: absolute !important;
    left: 50% !important;
    top: 50% !important;
    transform: translate(-50%, -50%) !important;
...
/* Boutons navbar mode nuit */
body.night-mode #desktop-navbar .btn,
body.night-mode #desktop-navbar .navbar-nav .nav-link,
body.night-mode #desktop-navbar .dropdown-toggle,
.night-mode #desktop-navbar .btn,
.night-mode #desktop-navbar .navbar-nav .nav-link,
.night-mode #desktop-navbar .dropdown-toggle {
    color: var(--night-text) !important;
...
body.night-mode #desktop-navbar .navbar-nav .nav-link:hover,
.night-mode #desktop-navbar .btn:hover,
.night-mode #desktop-navbar .navbar-nav .nav-link:hover {
...
body.night-mode .stat-value {
    color: var(--night-text) !important; /* Blanc en mode nuit - Priorité forte */
        ...
        /* ========================================
   CORRECTIONS COMPLÈTES MODE NUIT
        ======================================== */
...
/* Cartes et conteneurs en mode nuit */
...
/* Tableaux en mode nuit */
body.night-mode .table,
body.night-mode .modern-table,
.night-mode .table,
.night-mode .modern-table {
    background: var(--night-card-bg) !important;
    color: var(--night-text) !important;
}
...
.night-mode .btn-primary {
    background: linear-gradient(135deg, var(--night-primary), var(--night-accent)) !important;
    border: none !important;
    color: #000 !important;
}

/* Labels et textes en mode nuit */
...
/* Contenu des onglets en mode nuit */
...
/* Corrections spécifiques pour les éléments cachés */
body.night-mode .d-none,
.night-mode .d-none {
    display: none !important;
}

body.night-mode .d-block,
.night-mode .d-block {
    display: block !important;
}
