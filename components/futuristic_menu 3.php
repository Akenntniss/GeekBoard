                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-2">
                            <div class="col-6 col-md-3">
                                <button class="btn btn-success w-100 d-flex flex-column align-items-center p-3" data-bs-toggle="modal" data-bs-target="#nouvelles_actions_modal" data-bs-dismiss="modal">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof bootstrap === 'undefined') {
        console.error('❌ Bootstrap non disponible pour le modal');
    } else {
        console.log('✅ Bootstrap disponible pour le modal');
    }
});
</script>