<?php
/**
 * Version corrigée et simplifiée de traiter_devis_client.php
 */
...
try {
    ...
    try {
        // Vérifier que le devis existe et est dans le bon état
        ...
        if ($action === 'accepter') {
            ...
            // Enregistrer l'acceptation avec signature
