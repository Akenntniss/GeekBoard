...
<div class="modal fade" id="futuristicMenuModal" tabindex="-1" aria-labelledby="futuristicMenuModalLabel" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
            ...
            <div class="futuristic-menu-body">
                ...
                <div class="menu-section">
                    ...
                    <div class="menu-grid">
                        ...
                        <!-- Inventaire -->
                        <a href="index.php?page=inventaire" class="menu-card <?php echo $currentPage == 'inventaire' ? 'active' : ''; ?>" data-bs-dismiss="modal">
                            <div class="card-glow"></div>
                            <div class="card-content">
                                <div class="card-icon">
                                ...
                                <div class="card-info">
                                    ...
                                    <p class="card-subtitle">Gestion du stock</p>
                                </div>
                            </div>
                            <div class="card-overlay"></div>
                        </a>
...
<!-- Script d'initialisation du modal avec backdrop -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    // Initialiser le modal avec backdrop
    const futuristicModal = document.getElementById('futuristicMenuModal');
    
    if (futuristicModal) {
        // Créer une instance Bootstrap Modal avec backdrop
        const modalInstance = new bootstrap.Modal(futuristicModal, {
            backdrop: true,
            keyboard: true,
            focus: true
        });
        ...
        window.futuristicModalInstance = modalInstance;
        
        // Ajouter un événement pour s'assurer que le backdrop est créé
        futuristicModal.addEventListener('show.bs.modal', function() {
            // Forcer la création du backdrop si nécessaire
            setTimeout(function() {
                let backdrop = document.querySelector('.modal-backdrop');
                if (!backdrop) {
                    // Créer manuellement le backdrop
                ...
                // Appliquer les styles spécifiques au backdrop
                if (document.body.classList.contains('futuristic-theme')) {
                    backdrop.classList.add('futuristic-backdrop');
                }
            }, 10);
        });
        
        // Nettoyer le backdrop lors de la fermeture
        futuristicModal.addEventListener('hidden.bs.modal', function() {
