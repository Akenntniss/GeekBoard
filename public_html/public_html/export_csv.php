<?php
// Export CSV intégré au système d'authentification GeekBoard
...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['user_role']) || $_SESSION['user_role'] !== 'admin') {
    ...
    echo 'Accès non autorisé - Veuillez vous connecter en tant qu\'administrateur';
    exit;
}

// Initialiser la connexion magasin
...
if (!isset($_GET['date_start']) || !isset($_GET['date_end'])) {
    ...
    echo 'Paramètres manquants: date_start et date_end requis';
    exit;
}
