...
<nav id="desktop-navbar" class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm py-2" style="display: block !important; visibility: visible !important; opacity: 1 !important; height: var(--navbar-height) !important; position: fixed !important; top: 0 !important; left: 0 !important; right: 0 !important; z-index: 1030 !important;">
    <div class="container-fluid px-3">
        ...
        <div class="d-none d-lg-flex align-items-center ms-auto gap-2">
            <!-- Bouton Nouvelle (à droite) - Style identique au hamburger -->
            ...
            <button class="hamburger-btn main-menu-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#mainMenuOffcanvas" aria-controls="mainMenuOffcanvas">
                <span></span>
                <span></span>
                <span></span>
            </button>
        ...
        <button class="hamburger-btn navbar-toggler d-lg-none ms-auto main-menu-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#mainMenuOffcanvas" aria-controls="mainMenuOffcanvas">
            <span></span>
            <span></span>
            <span></span>
        </button>
