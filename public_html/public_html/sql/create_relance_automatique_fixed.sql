...
-- À exécuter sur CHAQUE base de données de magasin (geekboard_mkmkmk, geekboard_cannesphones, etc.)
...
-- Insérer une configuration par défaut (remplacez X par l'ID réel du magasin)
-- Pour mkmkmk, utilisez l'ID approprié
INSERT IGNORE INTO `relance_automatique_config` (`shop_id`, `est_active`, `relances_horaires`)
VALUES (1, 0, JSON_ARRAY('09:00', '14:00', '17:00'));
