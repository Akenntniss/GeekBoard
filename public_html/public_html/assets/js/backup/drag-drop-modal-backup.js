 ...
 *    - Les éléments avec classe 'draggable-card' peuvent être glissés
 *    - Les boutons avec classes 'filter-btn droppable' sont des zones de dépôt
 * 
 * 2. Flow de la fonctionnalité:
 *    a. L'utilisateur glisse une carte vers une catégorie de statut
 *    b. Quand la carte est déposée, un modal s'ouvre pour choisir un statut spécifique
 *    c. L'utilisateur choisit un statut, et l'API update_repair_specific_status.php est appelée
 *    d. La carte est mise à jour avec le nouveau statut
 * 
 * 3. APIs utilisées:
 *    - get_statuts_by_category.php: Récupère les statuts disponibles pour une catégorie
 *    - update_repair_specific_status.php: Met à jour le statut d'une réparation
 *
 * COMMENT RESTAURER CETTE FONCTIONNALITÉ EN CAS DE PROBLÈME:
 * ----------------------------------------------------------
 * 1. S'assurer que le HTML du modal est présent dans la page principale
 * 2. Vérifier que les classes et attributs data-* sont présents sur les cartes et zones de dépôt
 * 3. S'assurer que les APIs AJAX existent et fonctionnent correctement
 * 4. Copier le code JavaScript pertinent dans un fichier JS ou dans un bloc <script>
 * 5. Ajouter les styles CSS nécessaires
 */

/**
 * PARTIE 1: HTML NÉCESSAIRE
 * =========================
 * Le modal pour le choix du statut à inclure dans la page principale:
 */
 ...
 * ========================
 * Styles pour le modal et les éléments draggable:
 */
...
/**
 * PARTIE 3: CODE JAVASCRIPT
 * ========================
 * Code complet pour initialiser et gérer le drag & drop avec modals:
 */
 ...
 * ===========================
 * Si la fonctionnalité de drag and drop ne fonctionne pas correctement:
 * 
 * 1. Vérifiez la console du navigateur pour les erreurs JavaScript
 * 
 * 2. Assurez-vous que les éléments HTML ont les bonnes classes et attributs:
 *    - Les cartes/lignes doivent avoir la classe 'draggable-card'
 *    - Les cartes/lignes doivent avoir les attributs 'data-id' ou 'data-repair-id'
 *    - Les cartes/lignes doivent avoir l'attribut 'data-status'
 *    - Les cartes/lignes doivent avoir l'attribut 'draggable="true"'
 *    - Les cartes/lignes doivent contenir un élément avec la classe 'status-indicator'
 *    - Les zones de dépôt doivent avoir les classes 'filter-btn droppable'
 *    - Les zones de dépôt doivent avoir l'attribut 'data-category-id'
 * 
 * 3. Vérifiez que le modal avec l'ID 'chooseStatusModal' existe dans le document
 * 
 * 4. Vérifiez que les APIs AJAX fonctionnent correctement:
 *    - get_statuts_by_category.php doit retourner un JSON avec les statuts disponibles
 *    - update_repair_specific_status.php doit mettre à jour le statut de la réparation
 * 
 * 5. Vérifiez que les champs cachés existent dans le modal:
 *    - input#chooseStatusRepairId
 *    - input#chooseStatusCategoryId
 * 
 * 6. Assurez-vous que Bootstrap est correctement chargé pour le fonctionnement du modal
 */ 