...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function detectDarkMode() {
        ...
        return prefersDarkMode || hasBodyDarkClass || hasHtmlDarkClass || hasDataTheme;
    }
    ...
    function initializeTheme() {
        // Forcer le thème futuriste si mode sombre détecté
        if (isDarkModeActive && currentTheme === 'corporate') {
        ...
        if (currentTheme === 'futuristic') {
            ...
            // Ajouter aussi la classe au modal directement
    ...
    function toggleTheme() {
        ...
        if (currentTheme === 'corporate') {
            currentTheme = 'futuristic';
            document.body.classList.add('futuristic-theme');
            if (modal) modal.classList.add('futuristic-mode');
            startParticles();
            playThemeTransitionSound();
        } else {
            currentTheme = 'corporate';
            document.body.classList.remove('futuristic-theme');
            if (modal) modal.classList.remove('futuristic-mode');
            stopParticles();
        }
