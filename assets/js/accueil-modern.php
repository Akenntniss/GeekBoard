...
(function() {
    ...
    window.openStatsModal = function(statType) {
        ...
        if (checkSystemReady()) {
            ...
            console.log('⏳ Système non prêt, utilisation du fallback');
            
            // Fallback simple : afficher une alerte avec les informations
            showStatsFallback(statType);
            
            // Ajouter à la file d'attente pour quand le système sera prêt
    ...
    // Fonction de fallback simple pour afficher les statistiques
    function showStatsFallback(statType) {
        const statLabels = {
        ...
        const statValues = {
            'nouvelles_reparations': <?php echo $stats_journalieres['nouvelles_reparations']; ?>,
            'reparations_effectuees': <?php echo $stats_journalieres['reparations_effectuees']; ?>,
            'reparations_restituees': <?php echo $stats_journalieres['reparations_restituees']; ?>,
            'devis_envoyes': <?php echo $stats_journalieres['devis_envoyes']; ?>
        };
        
        const label = statLabels[statType] || 'Statistique';
        const value = statValues[statType] || 0;
        
        // Créer un modal Bootstrap simple
        const modalHTML = `
        <div class="modal fade" id="statsSimpleModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <p class="lead">${label} aujourd'hui</p>
                        <small class="text-muted">Le système de statistiques avancées se charge...</small>
                    </div>
        ...
        const existingModal = document.getElementById('statsSimpleModal');
        if (existingModal) {
        ...
        // Afficher le modal
        const modal = new bootstrap.Modal(document.getElementById('statsSimpleModal'));
        modal.show();
        
        console.log('📊 Modal de fallback affiché pour:', statType);
    }
