...
(function() {
    ...
    function initModalManager() {
        if (isInitialized) {
            console.log('Gestionnaire de modales déjà initialisé');
            return;
        }
        
        console.log('🔧 Initialisation du gestionnaire unifié des modales...');
        ...
        isInitialized = true;
        console.log('✅ Gestionnaire unifié des modales initialisé');
    }
    ...
    function setupErrorHandler() {
        ...
        window.onerror = function(message, source, lineno, colno, error) {
            ...
            if (messageStr.includes('Illegal invocation') && 
                ...
                console.log('🔇 Erreur Bootstrap ignorée:', messageStr);
