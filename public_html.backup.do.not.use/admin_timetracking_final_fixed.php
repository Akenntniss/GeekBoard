 ...
 * Version avec endpoint AJAX séparé pour éviter les conflits HTML/JSON
 */
...
// PAS de traitement POST ici - tout va vers l'endpoint AJAX
...
<script>
// JavaScript utilisant l'endpoint AJAX séparé
const AJAX_ENDPOINT = 'admin_timetracking_ajax_endpoint.php';
