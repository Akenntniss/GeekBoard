...
<style>
/* Mode sombre pour les modaux Bootstrap */
...
body.dark-mode .form-select {
    background-color: var(--dark-input-bg, #1f2937) !important;
    border-color: var(--dark-border-color, #374151) !important;
    color: var(--dark-text-primary, #f9fafb) !important;
}
...
body.dark-mode .form-select:focus {
    ...
    box-shadow: 0 0 0 0.2rem rgba(98, 130, 255, 0.25) !important;
}
...
/* Mode sombre pour les boutons dans les modaux */
