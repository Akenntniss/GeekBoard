...
.filter-btn i {
    ...
    */
    ...
    /* Mode sombre pour les champs Appareil et Problème - seulement le contenu comme les autres colonnes */
    body.dark-mode .appareil-info,
    body.dark-mode .probleme-text {
        background: rgba(31, 41, 59, 0.7) !important;
    ...
    /* Effet hover pour les champs Appareil et Problème */
    body.dark-mode .table-row:hover .appareil-info,
    body.dark-mode .table-row:hover .probleme-text {
...
<link rel="stylesheet" href="../assets/css/modern-filters.css?v=<?php echo time(); ?>">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-12">
                                                    <div class="d-flex gap-2 flex-wrap">
                                                        ...
                                                        ${repair.client_telephone ? `<button class="btn btn-info btn-sm" onclick="openSmsModal('${repair.client_id}', '${repair.client_nom}', '${repair.client_prenom}', '${repair.client_telephone}')"><i class="fas fa-sms me-1"></i>SMS</button>` : ''}
...
/* Styles pour le badge de garantie simple - SANS RECTANGLE */
.warranty-badge {
    position: absolute;
    top: calc(50% + 0cm);
    right: 15px;
...
/* Couleurs selon l'état de la garantie - TEXTE SIMPLE SEULEMENT */
.warranty-active {
    background: none;
    color: #047857;
    border: none;
...
.warranty-active .warranty-text::before {
    background: #34d399;
...
.warranty-expired .warranty-text::before {
    background: #f87171;
...
.warranty-expiring .warranty-text::before {
    background: #fbbf24;
...
.warranty-none .warranty-text::before {
    background: #9ca3af;
...
<!-- ANCIEN MODAL SUPPRIMÉ - Utiliser le modal updateStatusModal en fin de fichier -->

<!-- Suppression des anciens includes de modal et scripts de debug/override -->
...
/* Mise en page plein écran fiable pour le modal Devis en attente */
...
#devisEnAttenteModal .modal-content { height: 100% !important; display: flex; flex-direction: column; }
#devisEnAttenteModal .modal-body { flex: 1 !important; overflow: hidden !important; padding: 0 !important; }
...
/* Appliquer le fond du loader à la page réparations - MODE JOUR ET NUIT */
body,
body.dark-mode,
body.light-mode,
html {
