        ...
        <?php else: ?>
            <div class="mission-cards-container">
                <?php foreach ($missions_en_cours as $mission): ?>
                    <div class="dashboard-card mission-row">
                        <!-- En-tête de la carte -->
                        ...
                        <div class="card-footer">
                            <?php if ($mission['validations_validees'] < $mission['nombre_taches']): ?>
                                <a href="javascript:void(0)" class="mission-action-btn" onclick="validerTache(<?php echo $mission['id']; ?>)">
            ...
            <div class="mission-cards-container">
                <?php foreach ($missions_disponibles as $mission): ?>
                    <div class="dashboard-card mission-row">
                        ...
                        <!-- Pied avec action -->
                        <div class="card-footer">
                            <a href="javascript:void(0)" class="mission-action-btn" onclick="accepterMission(<?php echo $mission['id']; ?>)">
