                    ...
                    <tbody>
                        <?php if (count($commandes_recentes) > 0): ?>
                            <?php foreach ($commandes_recentes as $commande): ?>
                                <tr class="table-row-hover" onclick="afficherDetailsCommande(event, <?php echo $commande['id']; ?>)" style="cursor: pointer;" data-commande-id="<?php echo $commande['id']; ?>">
...
.dark-mode .modal-header-futuristic {
    background-color: #212938; /* Gris-bleu plus clair qui correspond à l'image */
...
.dark-mode .modal-header-futuristic .modal-title {
    font-size: 1.3rem;
    color: #4285F4; /* Bleu plus vif qui correspond au texte dans l'image */
    font-weight: 500;
    display: flex;
    align-items: center;
...
.dark-mode .btn-modal-close:hover {
    background-color: #4b5563; /* Gris légèrement plus clair */
...
.dark-mode .futuristic-modal-footer {
    background-color: #111827; /* Même couleur que l'en-tête */
...
.dark-mode .status-progress-bar {
    display: none; /* Suppression de la barre de progression qui peut nuire à l'apparence */
}

/* Style pour le bouton "voir-toutes-taches" en mode nuit */
.dark-mode #voir-toutes-taches.btn-secondary {
    background-color: #3b82f6; /* Bleu plus vif */
    border-color: #2563eb;
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body">
                <div class="commande-detail-container">
                    ...
                    <div id="commande-description-loader" class="text-center py-4" style="display: flex; justify-content: center; align-items: center;">
                    ...
                    <div id="commande-details-content" style="display: none;">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-8">
                                <h5 id="commande-reference" class="fw-bold text-primary"></h5>
                                <p id="commande-piece-nom" class="mb-1 fs-6"></p>
                            </div>
                            <div class="col-md-4 text-end">
                                <span id="commande-statut" class="badge fs-6"></span>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-card p-3 border rounded bg-light">
                                    <h6 class="fw-semibold mb-2">
                                        <i class="fas fa-user me-2 text-info"></i>Client
                                    </h6>
                                    <p id="commande-client" class="mb-1"></p>
                                    <p id="commande-client-tel" class="mb-0 text-muted small"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-card p-3 border rounded bg-light">
                                    <h6 class="fw-semibold mb-2">
                                        <i class="fas fa-truck me-2 text-warning"></i>Fournisseur
                                    </h6>
                                    <p id="commande-fournisseur" class="mb-0"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="info-item">
                                    <label class="fw-semibold text-muted small">Quantité</label>
                                    <p id="commande-quantite" class="mb-0"></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="info-item">
                                    <label class="fw-semibold text-muted small">Prix estimé</label>
                                    <p id="commande-prix" class="mb-0 fw-bold text-success"></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="info-item">
                                    <label class="fw-semibold text-muted small">Urgence</label>
                                    <p id="commande-urgence" class="mb-0"></p>
                                </div>
                            </div>
                        </div>

                        <!-- Code-barres si disponible -->
                        <div id="commande-code-barre-section" class="mb-3" style="display: none;">
                            <div class="info-item">
                                <label class="fw-semibold text-muted small">Code-barres</label>
                                <p id="commande-code-barre" class="mb-0 font-monospace"></p>
                            </div>
                        </div>

                        <!-- Description si disponible -->
                        <div id="commande-description-section" class="mb-3" style="display: none;">
                            <div class="info-item">
                                <label class="fw-semibold text-muted small">Description</label>
                                <p id="commande-description" class="mb-0"></p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="info-item">
                                    <label class="fw-semibold text-muted small">Date de création</label>
                                    <p id="commande-date-creation" class="mb-0"></p>
                                </div>
                            </div>
                            <div class="col-md-4" id="commande-date-commande-section" style="display: none;">
                                <div class="info-item">
                                    <label class="fw-semibold text-muted small">Date de commande</label>
                                    <p id="commande-date-commande" class="mb-0"></p>
                                </div>
                            </div>
                            <div class="col-md-4" id="commande-date-reception-section" style="display: none;">
                                <div class="info-item">
                                    <label class="fw-semibold text-muted small">Date de réception</label>
                                    <p id="commande-date-reception" class="mb-0"></p>
                                </div>
                            </div>
                        </div>

                        <!-- Notes si disponibles -->
                        <div id="commande-notes-section" class="mb-3" style="display: none;">
                            <div class="info-item">
                                <label class="fw-semibold text-muted small">Notes</label>
                                <p id="commande-notes" class="mb-0"></p>
                            </div>
                        </div>

                        <!-- Commentaire interne si disponible -->
                        <div id="commande-commentaire-section" class="mb-3" style="display: none;">
                            <div class="info-item">
                                <label class="fw-semibold text-muted small">Commentaire interne</label>
                                <p id="commande-commentaire" class="mb-0"></p>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Section d'erreur -->
                    <div id="commande-error-container" class="alert alert-danger mt-2" style="display:none;">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        <span class="error-message">Une erreur est survenue lors du chargement des détails de la commande.</span>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <a href="index.php?page=commandes_pieces" class="btn btn-primary">
                    <i class="fas fa-list-ul me-2"></i>Voir toutes les commandes
                </a>
