...
<!-- Script pour empêcher l'ouverture automatique du modal menu navigation -->
<script src="<?php echo $assets_path; ?>js/modal-menu-navigation-fix.js"></script>
...
<!-- CSS FINAL POUR BOUTONS NAVBAR - CHARGÉ EN DERNIER POUR PRIORITÉ MAXIMALE -->
<link rel="stylesheet" href="<?php echo $assets_path; ?>css/navbar-buttons-final-fix.css">

<!-- SCRIPT JAVASCRIPT POUR FORCER LES STYLES NAVBAR - SOLUTION ULTIME -->
<script src="<?php echo $assets_path; ?>js/navbar-buttons-force-styles.js"></script>
