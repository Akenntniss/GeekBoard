...
function showProductInfo(productData) {
    ...
    // Créer un modal d'ajustement de stock avec design adaptatif
    const modalHtml = `
        <div id="productInfoModal" class="modal fade stock-adjust-modal ${isDarkMode ? 'futuristic-mode' : 'corporate-mode'}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content stock-modal-content">
                    <div class="modal-header stock-modal-header">
                        <div class="header-content">
                            ...
                            <div class="header-text">
                                <h5 class="modal-title">Ajustement Stock</h5>
                                <small class="header-subtitle">Gestion des quantités</small>
                            </div>
                        </div>
                    ...
                    <div class="modal-body stock-modal-body">
                        ...
                        <div class="quantity-control-section">
                            ...
                            <div class="quantity-controls">
                                <button type="button" class="quantity-btn decrease-btn" id="decrease_stock_quantity" onclick="decreaseProductQuantity()">
                                ...
                                <button type="button" class="quantity-btn increase-btn" id="increase_stock_quantity" onclick="increaseProductQuantity()">
                    ...
                    <div class="modal-footer stock-modal-footer">
                        ...
                        <button type="button" class="action-btn save-btn" onclick="saveProductQuantity()">
    ...
    console.log('✅ [STOCK] Fonctions exposées globalement:', {
        decrease: typeof window.decreaseProductQuantity,
        increase: typeof window.increaseProductQuantity,
        save: typeof window.saveProductQuantity
    });
    
    // Les boutons utilisent maintenant onclick directement, pas besoin d'event listeners
    console.log('✅ [STOCK] Modal créé avec onclick handlers');
...
function decreaseProductQuantity() {
    console.log('📉 [STOCK] Fonction decrease appelée');
    
    const currentQuantityElement = document.getElementById('current_stock_display');
    const currentQuantityInput = document.getElementById('product_current_quantity');
    
    console.log('🔍 [STOCK] Éléments trouvés:', {
        currentQuantityElement: !!currentQuantityElement,
        currentQuantityInput: !!currentQuantityInput,
        currentValue: currentQuantityInput ? currentQuantityInput.value : 'N/A',
        currentText: currentQuantityElement ? currentQuantityElement.textContent : 'N/A'
    });
    ...
    if (currentQuantityElement && currentQuantityInput) {
        ...
        if (currentQuantity > 0) {
            ...
            console.log('📉 [STOCK] Quantité diminuée:', currentQuantity);
            console.log('📉 [STOCK] Affichage mis à jour:', {
                textContent: currentQuantityElement.textContent,
                innerText: currentQuantityElement.innerText,
                inputValue: currentQuantityInput.value
            });
            
            // Forcer le re-rendu avec un petit délai
            setTimeout(() => {
                currentQuantityElement.textContent = currentQuantity;
                currentQuantityElement.style.color = currentQuantity === 0 ? '#dc2626' : '';
            }, 10);
        ...
        console.error('❌ [STOCK] Éléments DOM non trouvés:', {
            currentQuantityElement: !!currentQuantityElement,
            currentQuantityInput: !!currentQuantityInput
        });
    }
...
function increaseProductQuantity() {
    console.log('📈 [STOCK] Fonction increase appelée');
    ...
    if (currentQuantityElement && currentQuantityInput) {
        ...
        console.log('📈 [STOCK] Quantité augmentée:', currentQuantity);
        console.log('📈 [STOCK] Affichage mis à jour:', {
            textContent: currentQuantityElement.textContent,
            innerText: currentQuantityElement.innerText,
            inputValue: currentQuantityInput.value
        ...
        setTimeout(() => {
            currentQuantityElement.textContent = currentQuantity;
            currentQuantityElement.style.color = '';
        }, 10);
