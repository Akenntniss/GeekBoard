...
?>
            <img src="<?php echo $navbar_assets_path; 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
...
?>images/logo/AppIcons_lightMode/appstore.png" alt="GeekBoard" height="40" class="light-mode-logo">
            <img src="<?php echo $navbar_assets_path; 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
...
?>images/logo/AppIcons-darkmode/playstore.png" alt="GeekBoard" height="40" class="dark-mode-logo" style="display: none;">
...
?>
                    <small class="ms-1">(DB: <?php echo htmlspecialchars($db_name); 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
...
<div id="mobile-dock" class="<?php echo ($isMobile || $isIPad) ? 'd-block' : 'd-lg-none'; 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
...
?>" <?php if (strpos($_SERVER['HTTP_USER_AGENT'], 'Safari') !== false && !strpos($_SERVER['HTTP_USER_AGENT'], 'Chrome') !== false && !$isIPad && !$isMobile): 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
...
?>style="display: none !important; visibility: hidden !important;"<?php endif; 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
...
?>images/logo/AppIcons_lightMode/appstore.png" alt="GeekBoard" height="30" class="me-2 light-mode-logo">
            <img src="<?php echo $navbar_assets_path; 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
...
?>images/logo/AppIcons-darkmode/playstore.png" alt="GeekBoard" height="30" class="me-2 dark-mode-logo" style="display: none;">
            Menu Principal
        </h5>
...
?>
                            <span class="badge rounded-pill bg-danger position-absolute top-0 end-0 translate-middle"><?php echo $tasks_count; 
<!-- Inclure le JavaScript de time tracking -->
<script src="<?php echo $navbar_assets_path; ?>js/time_tracking.js"></script>
