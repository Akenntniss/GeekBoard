...
?>
<nav id="desktop-navbar" class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm py-2" style="height: var(--navbar-height) !important; position: fixed !important; top: 0 !important; left: 0 !important; right: 0 !important; z-index: 1030 !important;">
...
/* 🔧 CORRECTION NAVBAR RESPONSIVE - MODE MOBILE/DESKTOP */
@media (max-width: 991px) {
    /* Cacher complètement la navbar desktop en mode mobile */
    #desktop-navbar {
        display: none !important;
    ...
    /* S'assurer que le dock mobile est visible en mode mobile */
    #mobile-dock {
        display: block !important;
    }
    
    /* Ajuster le body pour éviter l'espace réservé à la navbar desktop */
    body {
...
@media (min-width: 992px) {
    /* Afficher la navbar desktop sur grand écran */
    #desktop-navbar {
        display: block !important;
    ...
    /* Cacher le dock mobile sur desktop */
    #mobile-dock {
        display: none !important;
    }
        ...
        <div class="launchpad-container offcanvas-launchpad">
            ...
            <div class="launchpad-section">
                ...
                <div class="launchpad-section-content">
                    ...
                    <!-- TEST: Lien visible pour tous temporairement -->
                    <a href="admin_timetracking.php" class="launchpad-item <?php echo (strpos($_SERVER['REQUEST_URI'], 'admin_timetracking.php') !== false) ? 'active' : ''; ?>">
                        <div class="launchpad-icon launchpad-icon-timetracking">
                            <i class="fas fa-clock"></i>
                        </div>
                        <span>🔍 TEST - Pointage Admin</span>
                    </a>
