...
if (!isset($_SESSION['user_id'])) {
    ...
    if (in_array($page, $no_auth_pages)) {
        ...
        // Analyser le host pour détecter les sous-domaines
        $is_subdomain = false;
    ...
    if (isSafari) {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (existingNavbar && !alreadyCreated) {
                ...
                console.log("⚠️ Aucune navbar trouvée, création de secours nécessaire");
                
                // Creer une barre de navigation de secours SEULEMENT si aucune n existe
                const navbar = document.createElement("nav");
                navbar.id = "legacy-desktop-navbar-disabled";
                navbar.className = "navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm py-2";
                navbar.setAttribute(\'data-safari-created\', \'true\'); // 🏷️ Marquer comme créée par Safari
                ...
                console.log("🔧 Navbar de secours créée pour Safari");
            }
