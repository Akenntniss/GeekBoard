<?php
// Mock de la connexion DB pour tester directement sur geekboard_mkmkmk
function getShopDBConnection() {
    try {
        return new PDO("mysql:host=localhost;dbname=geekboard_mkmkmk;charset=utf8mb4", 'root', 'Mamanmaman01#', [
