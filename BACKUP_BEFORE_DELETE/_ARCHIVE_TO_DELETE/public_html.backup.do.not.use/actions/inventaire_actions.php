...
function ajouterProduit() {
    ...
    try {
        $stmt = $shop_pdo->prepare("
            INSERT INTO produits (reference, nom, description, fournisseur_id, prix_achat, prix_vente, quantite, seuil_alerte, suivre_stock)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
        
        $suivre_stock = isset($_POST['suivre_stock']) ? 1 : 0;
