 ...
 * RENAMED pour éviter conflit avec subdomain_config.php
 */
function detectShopNameFromSubdomain() {
 ...
 * Cette fonction est importante car certains anciens fichiers utilisent getMainDBConnection()
 */
...
dbDebugLog("🔧 Configuration database.php LOCAL chargée - Fonction renamed pour éviter conflit");
?> 