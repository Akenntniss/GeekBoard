<?php
/**
 * Endpoint AJAX pour les actions d'administration du pointage
 * Version corrigée avec initialisation complète de GeekBoard
 */

// Forcer le header JSON dès le début
header('Content-Type: application/json');

// Initialiser l'environnement GeekBoard complet
require_once __DIR__ . '/config/database.php';

// Démarrer la session avec la même config que GeekBoard
session_start();

// Vérifier les droits admin - Debug amélioré
...
try {
    ...
    switch ($_POST['action']) {
        ...
        case 'debug_session':
            // Action de debug pour vérifier la session
            $response = [
                'success' => true, 
