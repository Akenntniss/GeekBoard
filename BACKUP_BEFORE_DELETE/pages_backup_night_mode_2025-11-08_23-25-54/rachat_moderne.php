...
async function submitRachatForm(e) {
    ...
    const photoTypes = ['identite', 'appareil', 'client'];
    ...
    try {
        ...
        if (data.success) {
            ...
            // Ajouter les informations de debug si disponibles
            if (data.debug && Array.isArray(data.debug)) {
                console.error('🔍 Debug rachat:', data.debug);
                // Ne pas afficher le debug dans l'interface utilisateur, juste dans la console
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fonction pour basculer manuellement le thème (si nécessaire)
    window.toggleTheme = function() {
        ...
        if (newTheme === 'dark') {
            document.body.classList.add('night-mode');
            console.log('🌙 Mode nuit activé manuellement');
        } else {
            document.body.classList.remove('night-mode');
            console.log('☀️ Mode jour activé manuellement');
        }
    };
});
</script>
