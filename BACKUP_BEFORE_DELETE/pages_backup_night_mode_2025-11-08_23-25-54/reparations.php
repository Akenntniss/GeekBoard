...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (savedDarkMode === 'true') {
        ...
        // Vérifier les préférences système si aucune préférence sauvegardée
    ...
    // Chercher le bouton de toggle dans la navbar ou créer un gestionnaire global
    const toggleDarkMode = document.getElementById('toggleDarkMode');
    
    if (toggleDarkMode) {
        // Mettre à jour l'icône initiale
        updateDarkModeIcon(toggleDarkMode, document.body.classList.contains('dark-mode'));
        ...
        // Si le bouton n'existe pas, créer une fonction globale pour le mode nuit
        window.toggleDarkMode = function() {
            const isDarkMode = document.body.classList.toggle('dark-mode');
            localStorage.setItem('darkMode', isDarkMode);
        };
        
        // Appliquer le mode sombre même sans bouton visible
        if (savedDarkMode === 'true') {
            document.body.classList.add('dark-mode');
        }
    }
...
// Fonction pour mettre à jour l'icône du mode sombre/clair
