...
/* ✅ OPTIMISÉ - Background simplifié en mode nuit */
body.dark-mode {
...
// ✅ OPTIMISÉ - Event delegation au lieu de setInterval
document.addEventListener('click', function(e) {
    if (e.target.matches('.btn-problem-shortcut') || e.target.closest('.btn-problem-shortcut')) {
        const button = e.target.matches('.btn-problem-shortcut') ? e.target : e.target.closest('.btn-problem-shortcut');
        handleShortcutClick({ currentTarget: button });
    }
}, { passive: false });
