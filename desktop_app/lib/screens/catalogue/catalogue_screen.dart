      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Text(
              product['reference'] ?? '-', 
              style: TextStyle(color: Colors.grey[400], fontFamily: 'monospace', fontSize: 12),
            )
          ),
          
          // Brand
          Expanded(flex: 1, child: Text(product['brand'] ?? '-', style: const TextStyle(color: Colors.white70))),
          
          // Model
          Expanded(flex: 1, child: Text(product['model'] ?? '-', style: const TextStyle(color: Colors.white70))),
