            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _lowStockOnly ? const Color(0xFFF59E0B).withOpacity(0.2) : (isDark ? const Color(0xFF0F172A) : Colors.grey.shade100),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: _lowStockOnly ? const Color(0xFFF59E0B) : (isDark ? Colors.white.withOpacity(0.1) : Colors.grey.shade300)
                    ),
                  ),
                  child: Row(
                    children: [
                      Icon(
                        ...
                        color: _lowStockOnly ? const Color(0xFFF59E0B) : (isDark ? Colors.grey[400] : Colors.grey[600]),
                        size: 20,
                      ),
