...
class SubdomainDatabaseDetector {
    ...
    private $main_config = [
        ...
        'maisondugeek' => 'geekboard_maisondugeek',
        'mdg' => 'geekboard_mdg',
    ...
    /**
     * Alias pour getCurrentShopInfo() - Utilisé par NewSmsService
     */
    public function getShopInfo() {
        return $this->getCurrentShopInfo();
    }
    
    /**
     * Retourne le sous-domaine actuel
     */
    public function getCurrentSubdomain() {
        return $this->detectSubdomain();
    }
}
