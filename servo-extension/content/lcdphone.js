/**
 * SERVO Extension - Content Script pour LCD-Phone
...
(function () {
    ...
    // Vérifier si on est sur une page produit LCD-Phone (PrestaShop)
    ...
    function extractProductData() {
        ...
        const priceEl = document.querySelector('.current-price span[itemprop="price"]') ||
            document.querySelector('.current-price');
        const refEl = document.querySelector('.product-reference span');

        if (!nameEl) {
            console.log('[SERVO LCD-Phone] Impossible de trouver le nom du produit');
            return null;
        }
    ...
    async function searchClients(query) {
        ...
        try {
            ...
            console.error('[SERVO LCD-Phone] Erreur recherche:', error);
            resultsDiv.innerHTML = '<div class="servo-no-results">Erreur de connexion<br><small>Vérifiez l\'URL de votre Dashboard dans les paramètres de l\'extension</small></div>';
        }
    }
    ...
    async function createAndAddClient(nom, prenom, phone, email) {
        ...
        try {
            ...
            console.error('[SERVO LCD-Phone] Erreur création client:', error);
    ...
    async function confirmAddToServo(clientId) {
        ...
        try {
            ...
            console.error('[SERVO LCD-Phone] Erreur:', error);
    ...
    function injectServoButton() {
        ...
        console.log('[SERVO LCD-Phone] Bouton injecté', productData);
    }
